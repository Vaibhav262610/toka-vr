    ...
    <>
      <div className="flex flex-col  md:flex-row items-center justify-center gap-10">
        <div className="flex flex-col mt-44">
          ...
          <h1 className="mt-2 text-6xl !font-extralight  ">Make your life</h1>
          <div className="flex gap-6 items-center">
            <h1 className="text-6xl ">easier with</h1>
            <img src="/sparkle.png" className="h-12 mt-3" />
          </div>
          <h1 className="text-6xl ">crypto</h1>
        ...
        <div className="relative">
          <img src="/bubble1.png" className="absolute mt-12 ml-32 hidden md:block "  width="45"/>
          <img src="/bubble2.png" className="absolute  mt-12 ml-80 left-28 hidden md:block "  width="35"/>
          <img src="/bubble1.png" className="absolute mt-72 ml-80 left-56   hidden md:block"  width="45"/>

          <div className="pl-10  ">
            <img src="/main_card.png " className=" animate-wiggle" width="500" />
          </div>
        </div>
      </div>
